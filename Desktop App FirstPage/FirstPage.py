...
class FirstPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        load = Image.open("S:\Python Desktop App\Desktop App FirstPage\img1.jpg")
...
class SecondPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        load = Image.open("S:\Python Desktop App\Desktop App FirstPage\img2.jpg")
        photo = ImageTk.PhotoImage(load)
        label = tk.Label(self, image=photo)
        label.image=photo
        label.place(x=0,y=0)
